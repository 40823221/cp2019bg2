...
(function dartProgram() {
  ...
  A = {
    main: function() {
      ...
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new A.main_closure(tempInput), {func: 1, ret: -1, args: [t2]}), false, t2);
    },
    main_closure: function main_closure(t0) {
      this.tempInput = t0;
    }
  };
  var holders = [C, H, J, P, W, A];
